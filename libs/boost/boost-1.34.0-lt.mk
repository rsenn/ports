...
LIBRARIES = $(boost_LIBRARIES:%=libboost_%.la)
TARGETS = $(LIBRARIES)
...
libboost_date_time.la: \
  libs/date_time/src/gregorian/date_generators.lo \
  libs/date_time/src/gregorian/greg_month.lo \
  libs/date_time/src/gregorian/greg_weekday.lo

libboost_filesystem.la: \
  $(patsubst %.cpp,%.lo,$(wildcard libs/filesystem/src/*.cpp))

libboost_iostreams.la: LIBADD = -lbz2 -lz
libboost_iostreams.la: \
  libs/iostreams/src/bzip2.lo \
  libs/iostreams/src/file_descriptor.lo \
  libs/iostreams/src/mapped_file.lo \
  libs/iostreams/src/zlib.lo

libboost_program_options.la: \
  libs/program_options/src/cmdline.lo \
  libs/program_options/src/config_file.lo \
  libs/program_options/src/convert.lo \
  libs/program_options/src/options_description.lo \
  libs/program_options/src/parsers.lo \
  libs/program_options/src/positional_options.lo \
  libs/program_options/src/utf8_codecvt_facet.lo \
  libs/program_options/src/value_semantic.lo \
  libs/program_options/src/variables_map.lo \
  libs/program_options/src/winmain.lo

libboost_python.la: \
  libs/python/src/converter/arg_to_python_base.lo \
  libs/python/src/converter/builtin_converters.lo \
  libs/python/src/converter/from_python.lo \
  libs/python/src/converter/registry.lo \
  libs/python/src/converter/type_id.lo \
  libs/python/src/dict.lo \
  libs/python/src/errors.lo \
  libs/python/src/list.lo \
  libs/python/src/long.lo \
  libs/python/src/module.lo \
  libs/python/src/numeric.lo \
  libs/python/src/object/class.lo \
  libs/python/src/object/enum.lo \
  libs/python/src/object/function.lo \
  libs/python/src/object/inheritance.lo \
  libs/python/src/object/iterator.lo \
  libs/python/src/object/life_support.lo \
  libs/python/src/object/pickle_support.lo \
  libs/python/src/object_operators.lo \
  libs/python/src/object_protocol.lo \
  libs/python/src/slice.lo \
  libs/python/src/str.lo \
  libs/python/src/tuple.lo \
  libs/python/src/wrapper.lo

libboost_regex.la: \
  $(patsubst %.cpp,%.lo,$(wildcard libs/regex/src/*.cpp))

libboost_serialization.la: \
  libs/serialization/src/basic_archive.lo \
  libs/serialization/src/basic_archive_impl.lo \
  libs/serialization/src/basic_iarchive.lo \
  libs/serialization/src/basic_iserializer.lo \
  libs/serialization/src/basic_oarchive.lo \
  libs/serialization/src/basic_oserializer.lo \
  libs/serialization/src/basic_pointer_iserializer.lo \
  libs/serialization/src/basic_pointer_oserializer.lo \
  libs/serialization/src/basic_serializer_map.lo \
  libs/serialization/src/basic_text_iprimitive.lo \
  libs/serialization/src/basic_text_oprimitive.lo \
  libs/serialization/src/basic_xml_archive.lo \
  libs/serialization/src/binary_iarchive.lo \
  libs/serialization/src/binary_oarchive.lo \
  libs/serialization/src/extended_type_info.lo \
  libs/serialization/src/extended_type_info_no_rtti.lo \
  libs/serialization/src/extended_type_info_typeid.lo \
  libs/serialization/src/polymorphic_iarchive.lo \
  libs/serialization/src/polymorphic_oarchive.lo \
  libs/serialization/src/text_iarchive.lo \
  libs/serialization/src/text_oarchive.lo \
  libs/serialization/src/void_cast.lo \
  libs/serialization/src/xml_grammar.lo \
  libs/serialization/src/xml_iarchive.lo \
  libs/serialization/src/xml_oarchive.lo

libboost_signals.la: \
  $(patsubst %.cpp,%.lo,$(wildcard libs/signals/src/*.cpp))
  
libboost_text_exec_monitor.la: \
  libs/test/src/compiler_log_formatter.lo \
  libs/test/src/execution_monitor.lo \
  libs/test/src/framework.lo \
  libs/test/src/plain_report_formatter.lo \
  libs/test/src/progress_monitor.lo \
  libs/test/src/results_collector.lo \
  libs/test/src/results_reporter.lo \
  libs/test/src/test_main.lo \
  libs/test/src/test_tools.lo \
  libs/test/src/unit_test_log.lo \
  libs/test/src/unit_test_main.lo \
  libs/test/src/unit_test_monitor.lo \
  libs/test/src/unit_test_parameters.lo \
  libs/test/src/unit_test_suite.lo \
  libs/test/src/xml_log_formatter.lo \
  libs/test/src/xml_report_formatter.lo

libboost_unit_test_framework.la: \
  libs/test/src/compiler_log_formatter.lo \
  libs/test/src/execution_monitor.lo \
  libs/test/src/framework.lo \
  libs/test/src/plain_report_formatter.lo \
...
libboost_wave.la: \
  $(patsubst %.cpp,%.lo,$(wildcard libs/wave/src/*.cpp libs/wave/src/cpplexer/re2clex/*.cpp))

libboost_wserialization.la: \
  libs/serialization/src/binary_wiarchive.lo \
  libs/serialization/src/binary_woarchive.lo \
  libs/serialization/src/basic_text_wiprimitive.lo \
  libs/serialization/src/basic_text_woprimitive.lo \
  libs/serialization/src/codecvt_null.lo \
  libs/serialization/src/text_wiarchive.lo \
  libs/serialization/src/text_woarchive.lo \
  libs/serialization/src/utf8_codecvt_facet.lo \
  libs/serialization/src/xml_wgrammar.lo \
  libs/serialization/src/xml_wiarchive.lo \
  libs/serialization/src/xml_woarchive.lo

libboost_thread.la: \
  libs/thread/src/barrier.lo \
  libs/thread/src/condition.lo \
  libs/thread/src/exceptions.lo \
  libs/thread/src/mutex.lo \
  libs/thread/src/once.lo \
  libs/thread/src/recursive_mutex.lo \
  libs/thread/src/thread.lo \
  libs/thread/src/tss.lo \
  libs/thread/src/tss_dll.lo \
  libs/thread/src/tss_hooks.lo \
  libs/thread/src/tss_null.lo \
  libs/thread/src/tss_pe.lo \
  libs/thread/src/xtime.lo

libboost_thread_mac.la: \
  libs/thread/src/mac/delivery_man.lo \
  libs/thread/src/mac/dt_scheduler.lo \
  libs/thread/src/mac/execution_context.lo \
  libs/thread/src/mac/init.lo \
  libs/thread/src/mac/msl_replacements/assert.lo \
  libs/thread/src/mac/msl_replacements/console_io.lo \
  libs/thread/src/mac/msl_replacements/malloc.lo \
  libs/thread/src/mac/msl_replacements/news_and_deletes.lo \
  libs/thread/src/mac/msl_replacements/time.lo \
  libs/thread/src/mac/os.lo \
  libs/thread/src/mac/ot_context.lo \
  libs/thread/src/mac/remote_call_manager.lo \
  libs/thread/src/mac/safe.lo \
  libs/thread/src/mac/scoped_critical_region.lo \
  libs/thread/src/mac/st_scheduler.lo \
  libs/thread/src/mac/thread_cleanup.lo
