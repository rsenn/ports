 ...
 * is located in the @sysconfdir@/phpmyadmin directory.
 */

// Load secret generated on postinst
include('@localstatedir@/lib/phpmyadmin/blowfish_secret.inc.php');

// Load autoconf local config
include('@localstatedir@/lib/phpmyadmin/config.inc.php');

// Load user's local config
include('@sysconfdir@/phpmyadmin/config.inc.php');
